...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_ambitiousaboutautism_dev_ambitiousaboutautism_dev_local.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_ambitiousaboutautism_dev_ambitiousaboutautism_dev_local.inc';
}
// </DDSETTINGS>
