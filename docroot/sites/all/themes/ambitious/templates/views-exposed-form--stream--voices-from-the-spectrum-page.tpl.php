...
<div class="sort-block advanced-sort-block filter-option">
    ...
    <div class="filter-slide">
      ...
      <div class="button-holder">
       <div class="views-exposed-widget views-submit-button filter-pink"> 
        <span class=" submit"><?php print $button; ?></span>
...
<fieldset>	  
 ...
 <a href="#" class="btn btn-pink btn-left filteroption" title="Filter by topic"><span>Filter by topic <em class="icon-Plus"></em></span></a>
		</div>
