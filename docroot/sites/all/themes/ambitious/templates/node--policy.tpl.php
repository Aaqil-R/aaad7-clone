   ...
   <div class="caption-frame">
    ...
    <div class="caption-text">
      <h1 class="caption-text-titles">
        <?php if(isset($content['field_policy_main_caption'])):?>
        <div class="caption-text-title caption-text-title-1">               
          <span>
            <?php print render($content['field_policy_main_caption']['#items'][0]['value']); ?>
          </span>
        </div>
      <?php endif; ?>
      <?php if(isset($content['field_policy_sub_caption'])):?>
      <div class="caption-text-title caption-text-title-2">               
        <span>
          <?php print render($content['field_policy_sub_caption']['#items'][0]['value']); ?>
        </span>
      </div>
    <?php endif; ?> 
  </h1>
...
style="background-image: url('<?php print image_style_url('banner_1080',$content['field_policy_featured_image']['#items'][0]['uri']); ?>')">
</div>
</div>
<?php if(isset($content['field_policy_featured_image_by'])):?>
  <div class="holder">
    <span class="pic-by">         
      <?php print t('© Photo by'); ?> 
      <?php print render($content['field_policy_featured_image_by']['#items'][0]['value']); ?>
    </span>
  </div>
<?php endif; ?> 
</section>  
