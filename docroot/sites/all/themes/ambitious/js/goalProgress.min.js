    ...
    $.fn.extend({
        goalProgress: function(options) {
            ...
            return this.each(function() {
                ...
                var progressBar = '<div id="count" class="progressBar">' + defaults.textBefore + currentAmountParsed + defaults.textAfter + "</div>";
                var progressBarWrapped =
                    '<div class="goalProgress">' + progressBar + "</div><div class='goal-amount'>£5000</div>";
