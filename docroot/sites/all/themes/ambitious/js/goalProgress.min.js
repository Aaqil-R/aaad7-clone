    ...
    $.fn.extend({
        goalProgress: function(options) {
            ...
            return this.each(function() {
                ...
                var progressBar = '<div id="count" class="progressBar">' + '<div class="gained-amount">' + defaults.textBefore + currentAmountParsed + '</div>' + '<div class="gained-text">' + defaults.textAfter + '</div>' + "</div>";
    ...
    $.fn.extend({
        goalProgress_landscape: function(options) {
            ...
            return this.each(function() {
                ...
                var currentAmountParsed = parseInt(defaults.currentAmount);
                var percentage = currentAmountParsed / goalAmountParsed * 100;
                var progressBar = '<div id="count" class="progressBar">' + '<div class="gained-text">' + defaults.textAfter + '</div>' + '<div class="gained-amount">' + defaults.textBefore + currentAmountParsed + '</div>' + "</div>";
                var progressBarWrapped =
                    '<div class="goalProgress">' + progressBar + "</div><div class='target-amount'> Target <span> £" + goalAmountParsed + "</span></div>";
                obj.append(progressBarWrapped);
                var rendered = obj.find("div.progressBar");
                rendered.each(function() {
                    //$(this).html($(this).text().replace(/\s/g, "&nbsp;"))
