...
function initFixedBlock() {
	...
	jQuery('#header').each(function() {
		...
		var panel = holder.find('.header-top');
...
function initViewMode() {
	jQuery(".view-mode").click(function(){
	   ...
	   if (jQuery(this).hasClass("list") ) {
         ...
         jQuery('#view-mode').removeClass('list-view');
      }
	});
}
...
function initMobileNav() {
	jQuery('body').mobileNav({
		hideOnClickOutside: true,
		menuActiveClass: 'school-active',
		menuOpener: '.school-opener',
		menuDrop: '.school-slide'
	});
	jQuery('body').mobileNav({
		hideOnClickOutside: true,
...
function initCustomHover() {
	jQuery('.num-holder a, .feature-holder').touchHover();
}
/*
